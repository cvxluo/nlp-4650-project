...
"""
For running hyperparameter space searching
"""
...
from transformers import (CONFIG_MAPPING, MODEL_WITH_LM_HEAD_MAPPING,
                          ...
                          LineByLineTextDataset, PreTrainedTokenizer,
                          TextDataset, Trainer, TrainingArguments, set_seed)
...
def main():
    ...
    best_run = trainer.hyperparameter_search(
        hp_space=hp_space_init, direction="minimize", backend="ray", n_trials=5
    )
    logger.info("Best run hyperparameters: ")
    logger.info(best_run.hyperparameters)
