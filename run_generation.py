...
import numpy as np
import torch
from transformers import (BertLMHeadModel, BertTokenizer, CTRLLMHeadModel,
                          CTRLTokenizer, GPT2LMHeadModel, GPT2Tokenizer,
...
MODEL_CLASSES = {
    ...
    "bert": (BertLMHeadModel, BertTokenizer),
...
def main():
    ...
    if isinstance(model, BertLMHeadModel):
        logger.info("Setting is_decoder to True")
